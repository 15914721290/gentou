...
// uncomment after placing your favicon in /views_assets
app.use(favicon(path.join(__dirname, 'views_assets', 'favicon.ico')));
app.use(logger('dev'));
...
//定义view中html对应的actions，目录为views_actions
